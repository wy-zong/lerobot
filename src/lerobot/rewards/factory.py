...
from .recap_sarm.configuration_recap_sarm import RECAPSARMConfig
...
def make_reward_model_config(reward_type: str, **kwargs) -> RewardModelConfig:
    ...
    Args:
        reward_type: The type of the reward model. Supported types include
                     "reward_classifier", "sarm", "recap_sarm".
    ...
    elif reward_type == "recap_sarm":
        return RECAPSARMConfig(**kwargs)
    else:
        try:
...
def make_reward_pre_post_processors(
    ...
    **kwargs,
    ...
    elif isinstance(reward_cfg, RECAPSARMConfig):
        from lerobot.rewards.recap_sarm.processor_recap_sarm import (
            make_recap_sarm_pre_post_processors,
        )

        return make_recap_sarm_pre_post_processors(
            config=reward_cfg,
            dataset_stats=kwargs.get("dataset_stats"),
